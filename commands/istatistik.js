...
module.exports = {
  ...
  run: async(client, interaction) => {
    ...
    .addFields({ name: 'Bot Sahibi', value: `! Efe Balcan#1996`, inline: false})
    ...
    .addFields({ name: '• İşletim Sistemi', value: `Windows 11 64 Bit`, inline: false})
    .addFields({ name: '• İşlemci', value: `${os.cpus().map(i => `${i.model}`)[0]}`, inline: false})
    .addFields({ name: '• Discord.JS sürüm', value: `14.3.0`, inline: true})
    .addFields({ name: '• Node.JS sürüm', value: `v16.14.2`, inline: true})
    .addFields({ name: '• Bot Kuruluş', value: `08.12.2021`, inline: true})
    .addFields({ name: '• Komut Sayısı', value: `22`, inline: true})
